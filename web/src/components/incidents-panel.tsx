          ...
          <DialogContent>
            ...
            <form onSubmit={handleCreateIncident} className="space-y-4 py-2">
              ...
              <DialogFooter className="pt-4">
                <Button type="submit" disabled={isSubmitting} className="w-full bg-indigo-600 hover:bg-indigo-500 text-white font-medium cursor-pointer">
                ...
                {incidents.map((inc) => (
                  <div
                    ...
                    className={`flex items-start justify-between p-4 cursor-pointer transition-colors ${
                      selectedIncidentId === inc.id ? "bg-muted/50 border-r-2 border-indigo-600" : "hover:bg-muted/30"
                    }`}
                  >
              ...
              <div className="flex flex-col flex-1 justify-between h-full space-y-4">
                  ...
                  <div className="space-y-4 relative pl-3 border-l border-border">
                    {selectedIncident.updates.map((up) => (
                      <div key={up.id} className="relative space-y-0.5">
                        <span className="absolute -left-[17px] top-1 size-2 rounded-full border border-card bg-indigo-600" />
                        <div className="flex items-center justify-between">
                ...
                <form onSubmit={handlePostUpdate} className="border-t border-border/60 pt-3 space-y-3 shrink-0">
                  ...
                  <div className="flex gap-2">
                    ...
                    />
                    <Button type="submit" disabled={isUpdating} size="sm" className="bg-indigo-600 text-white hover:bg-indigo-500 font-medium cursor-pointer">
                      {isUpdating ? "..." : "Post"}
                    </Button>
                  </div>
                </form>
